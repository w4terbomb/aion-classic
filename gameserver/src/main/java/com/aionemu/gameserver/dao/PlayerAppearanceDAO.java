...
public class PlayerAppearanceDAO
{
	...
	/**
	 * Loads player appearance DAO by player ID.<br>
	 ...
	 *
	 * @param player who's appearance to store
	 * @return true, if sql query was successful, otherwise false
	 */
	 ...
	 *
	 * @param id player id
	 * @param pa player appearance
	 * @return true, if sql query was successful, false otherwise
	 */
	public static boolean store(final int id, final PlayerAppearance pa)
	{
		return DB
				.insertUpdate(
