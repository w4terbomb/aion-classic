...
public class TwoFish {
	...
	private static final byte[] t00 = { 0x8, 0x1, 0x7, 0xD, 0x6, 0xF, 0x3, 0x2, 0x0, 0xB, 0x5, 0x9, 0xE, 0xC, 0xA,
			0x4 };
	private static final byte[] t01 = { 0xE, 0xC, 0xB, 0x8, 0x1, 0x2, 0x3, 0x5, 0xF, 0x4, 0xA, 0x6, 0x7, 0x0, 0x9,
			0xD };
	private static final byte[] t02 = { 0xB, 0xA, 0x5, 0xE, 0x6, 0xD, 0x9, 0x0, 0xC, 0x8, 0xF, 0x3, 0x2, 0x4, 0x7,
			0x1 };
	private static final byte[] t03 = { 0xD, 0x7, 0xF, 0x4, 0x1, 0x2, 0x6, 0xE, 0x9, 0xB, 0x3, 0x0, 0x8, 0x5, 0xC,
			0xA };
	//
	private static final byte[] t10 = { 0x2, 0x8, 0xB, 0xD, 0xF, 0x7, 0x6, 0xE, 0x3, 0x1, 0x9, 0x4, 0x0, 0xA, 0xC,
			0x5 };
	private static final byte[] t11 = { 0x1, 0xE, 0x2, 0xB, 0x4, 0xC, 0x3, 0x7, 0x6, 0xD, 0xA, 0x5, 0xF, 0x9, 0x0,
			0x8 };
	private static final byte[] t12 = { 0x4, 0xC, 0x7, 0x5, 0x1, 0x6, 0x9, 0xA, 0x0, 0xE, 0xD, 0x8, 0x2, 0xB, 0x3,
			0xF };
	private static final byte[] t13 = { 0xB, 0x9, 0x5, 0x1, 0xC, 0x3, 0xD, 0xE, 0x6, 0x4, 0x7, 0xF, 0x2, 0x0, 0x8,
			0xA };
	...
	public static int[] whitening(int[] plainText, int k0, int k1, int k2, int k3) {
		return new int[] { plainText[0] ^ k0, plainText[1] ^ k1, plainText[2] ^ k2, plainText[3] ^ k3 };
	}
	...
	public static int h(int input, int l0, int l1) {
		...
		final byte[] input11 = new byte[] { q1((byte) (q0((byte) (q0(x[0]) ^ y[0])) ^ z[0])),
				q0((byte) (q0((byte) (q1(x[1]) ^ y[1])) ^ z[1])), q1((byte) (q1((byte) (q0(x[2]) ^ y[2])) ^ z[2])),
	...
	public static byte[] asBytes(int intValue) {
		return new byte[] { (byte) (intValue), (byte) (intValue >>> 8), (byte) (intValue >>> 16),
				(byte) (intValue >>> 24), };
	}
	...
	public static byte[] asBytesBlock(int[] intValue) {
		return new byte[] { (byte) (intValue[0]), (byte) (intValue[0] >>> 8), (byte) (intValue[0] >>> 16),
				(byte) (intValue[0] >>> 24), (byte) (intValue[1]), (byte) (intValue[1] >>> 8),
				(byte) (intValue[1] >>> 16), (byte) (intValue[1] >>> 24), (byte) (intValue[2]),
				(byte) (intValue[2] >>> 8), (byte) (intValue[2] >>> 16), (byte) (intValue[2] >>> 24),
				(byte) (intValue[3]), (byte) (intValue[3] >>> 8), (byte) (intValue[3] >>> 16),
				(byte) (intValue[3] >>> 24), };
	}
