...
import com.aionemu.gameserver.network.aion.serverpackets.S_KEY;
...
public class AionConnection extends AConnection {
	...
	public final String Decode2ndPassword(byte[] data) {
		return crypt.Decode2ndPassword(data);
	}
}