	...
	private void thirstingBloodwing() {
		...
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				if (getPosition().getWorldMapInstance().getNpc(280802) == null &&
				    getPosition().getWorldMapInstance().getNpc(280803) == null &&
					getPosition().getWorldMapInstance().getNpc(280804) == null) {
					rndSpawn(280802, 2);
				}
			}
		}, 4000);
