...
public class Medeus_The_VileAI2 extends AggressiveNpcAI2
{
	...
	private void medeusDrake() {
		///Do you want know the true darkness?
		sendMsg(341383, getObjectId(), false, 0);
		///You cannot defeat me with your feeble strength.
		sendMsg(341385, getObjectId(), false, 3000);
		///I want to see you trembling with fear!
		sendMsg(341386, getObjectId(), false, 6000);
		if (getPosition().getWorldMapInstance().getNpc(280788) == null) {
			rndSpawn(280788, 1);
		}
	}
	...
	protected void handleBackHome() {
		...
		killNpc(instance.getNpcs(280788));
	}
