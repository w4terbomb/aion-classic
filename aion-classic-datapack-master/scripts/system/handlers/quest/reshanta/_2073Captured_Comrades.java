            ...
            if (targetId == 278002) {
				...
				switch (env.getDialog()) {
					case START_DIALOG: {
						...
						return defaultStartFollowEvent(env, (Npc) env.getVisibleObject(), 253641, 3, 4);
					}
				}
			}
