...
public class SM_ACCOUNT_AUTH_RESPONSE extends GsServerPacket {
	...
	private final long membershipExpire;
	 ...
	 * @param toll
	 */
	public SM_ACCOUNT_AUTH_RESPONSE(int accountId, boolean ok, String accountName, byte accessLevel, byte membership, long toll, long membershipExpire) {
